...
CREATE TABLE `Boardgames` (
    ...
    FOREIGN KEY (`publisherID`) REFERENCES `PrimaryPublishers`(`publisherID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `UsersBoardgames` (
    `userID` int(11) NOT NULL,
    `boardgameID` int(11) NOT NULL,
    PRIMARY KEY (`userID`,`boardgameID`),
...
INSERT INTO 'Users' ('userFirstName', 'userLastName', 'email') VALUES (':firstName', 
